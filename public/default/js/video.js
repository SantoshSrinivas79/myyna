/*! Video.js v4.2.2 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function() {
...
u.ka.extend=function(a){
    ...
    for(var e in a)a.hasOwnProperty(e)&&(d.prototype[e]=a[e]);return d
    };
...
u.hc=function(a){
    function c(){
        ...
        for(var g in e)"layerX"!==g&&"layerY"!==g&&(a[g]=e[g]);a.target||(a.target=a.srcElement||document);
...
u.e=function(a,c){
    ...
    for(e in c)w.call(c,e)&&(-1!==e.indexOf("aria-")||"role"==e?d.setAttribute(e,c[e]):d[e]=c[e]);return d
    };
...
u.k.B=function(a,c){
    if(!c)return a;
    for(var d in c)w.call(c,d)&&(a[d]=c[d]);return a
    };
u.k.fc=function(a,c){
    var d,e,g;
    a=u.k.copy(a);
    for(d in c)w.call(c,d)&&(e=a[d],g=c[d],a[d]=u.k.nc(e)&&u.k.nc(g)?u.k.fc(e,g):c[d]);return a
    };
...
u.Ab=function(a){
    for(var c in a)if(a[c]!==j)return l;return f
    };
...
t.buffered=function(){
    var a=L(this,"buffered"),c=a.length-1,d=this.u.kb=this.u.kb||0;
...
t.nb=function(){
    var a=u.Nb.xa;
    this.H=l;
    if(a)document[a.mb]();else this.h.Sa()?M(this,"exitFullScreen"):(N(this),this.j("fullscreenchange"));
    return this
    };
    ...
    if(a instanceof Array){
        var c;
            ...
            for(var d=0,e=this.g.techOrder;d<e.length;d++){
                ...
                if(h.isSupported())for(var k=0,q=c;k<q.length;k++){
                    var n=q[k];
...
t.update=function(){
    if(0<this.fa.length){
        ...
        if(this.Kb===b||a<this.Kb||this.La<=a){
            var c=this.fa,d=this.b.duration(),e=0,g=l,h=[],k,q,n,r;
            ...
            for(;;){
                ...
                if(n.ua<=a)e=Math.max(e,n.ua),n.Ha&&(n.Ha=l);
                    ...
                    n.Ha=f;
                if(g)if(0===r)break;else r--;
                else if(r===c.length-1)break;else r++
            }
            this.bc=h;
            this.La=d;
            this.Kb=e;
    ...
    i:function(a,c,d){
        ...
        if(a.g.tracks&&0<a.g.tracks.length){
            ...
            for(d=0;d<a.length;d++){
                e=a[d];
                var g=c,h=e.kind,k=e.label,q=e.language,n=e;
                e=g.za=g.za||[];
                n=n||{};
...
t.Ja=function(){
    for(var a=W(this.b),c=0,d=a.length,e,g,h=this.I=[];c<d;c++)if(e=a[c],e.J()==this.A&&e.tb()){
        if(2>e.readyState()){
            this.Gd=e;
...
if("undefined"!==typeof window.JSON&&"function"===window.JSON.parse)u.JSON=window.JSON;
    ...
    u.JSON.parse=function(a,c){
        function d(a,e){
            var k,q,n=a[e];
            if(n&&"object"===typeof n)for(k in n)Object.prototype.hasOwnProperty.call(n,k)&&(q=d(n,k),q!==b?n[k]=q:delete n[k]);return c.call(a,e,n)
            }
            var e;
        a=String(a);
        Z.lastIndex=0;
...
u.cc=function(){
    ...
    if(d&&0<d.length)for(var e=0,g=d.length;e<g;e++)if((c=d[e])&&c.getAttribute)c.player===b&&(a=c.getAttribute("data-setup"),a!==j&&(a=u.JSON.parse(a||"{}"),v(c,a)));
        else{
        u.jb();
        break
    }else u.Cc||u.jb()
